...
void Geometry::addNormal(float u, float v, float w){	
	normals.push_back(u);
	normals.push_back(v);
	normals.push_back(w);
}
...
void Geometry::makeTriangle(unsigned int vert0, unsigned int vert1, unsigned int vert2){
	...
	glm::vec3 norm0(normals[vert0*3 +0], normals[vert0*3 + 1], normals[vert0*3 + 2]); 
	glm::vec3 norm1(normals[vert1*3 +0], normals[vert1*3 + 1], normals[vert1*3 + 2]); 
	glm::vec3 norm2(normals[vert2*3 +0], normals[vert2*3 + 1], normals[vert2*3 + 2]); 
