...
void BrickGeometry::addVertex(float x, float y, float z){
...
void BrickGeometry::addTexture(float s, float t){	
	textureCoords.push_back(s);
	textureCoords.push_back(t);
}


float* BrickGeometry::getData(){
	return allData.data();
}

unsigned int BrickGeometry::getSize(){
	return allData.size();
}

unsigned int BrickGeometry::getSizeInBytes(){
	return allData.size()*sizeof(float);
}

// Create all data
void BrickGeometry::gen(){
...
void BrickGeometry::makeTriangle(unsigned int vert0, unsigned int vert1, unsigned int vert2){
...
unsigned int BrickGeometry::getIndicesSize(){
	return indices.size();
}

unsigned int* BrickGeometry::getIndicesData(){
	return indices.data();
}
