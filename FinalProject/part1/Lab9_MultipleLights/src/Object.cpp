...
&Camera::instance().getWorldToViewmatrix()[0][0]);
        ...
        myShader.setUniform3f("pointLights[0].lightColor",0.0f,1.0f,0.0f);
        ...
        myShader.setUniform3f("pointLights[1].lightColor",0.5f,0.5f,1.0f);
        myShader.setUniform3f("pointLights[1].lightPos",
                               Camera::instance().getEyeXPosition() + Camera::instance().getViewXDirection(),
                               Camera::instance().getEyeYPosition() + Camera::instance().getViewYDirection(),
                               Camera::instance().getEyeZPosition() + Camera::instance().getViewZDirection());
        myShader.setUniform1f("pointLights[1].ambientIntensity",0.5f);
        myShader.setUniform1f("pointLights[1].specularStrength",0.5f);
        ...
        myShader.setUniform3f("pointLights[2].lightColor",1.0f,0.0f,0.0f);
        myShader.setUniform3f("pointLights[2].lightPos", -1.0f, 0.5, 0.0);
        myShader.setUniform1f("pointLights[2].ambientIntensity",0.25f);
        myShader.setUniform1f("pointLights[2].specularStrength",0.25f);
        ...
        myShader.setUniform3f("pointLights[3].lightColor",0.0f,0.0f,0.5f);
        myShader.setUniform3f("pointLights[3].lightPos", 1, 0, 0);
        myShader.setUniform1f("pointLights[3].ambientIntensity",0.4f);
        myShader.setUniform1f("pointLights[3].specularStrength",0.4f);
